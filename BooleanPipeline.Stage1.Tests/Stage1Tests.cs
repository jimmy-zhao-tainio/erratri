...
namespace BooleanPipeline.Stage1.Tests;

public sealed class Stage1Tests
{
    [Fact]
    public void Run_TrimsMeshIds()
    {
        var input = new Stage0To1Context
        {
    ...
    public void OrchestratorStage_EnforcesValidation()
    {
        ...
        var pipeline = BooleanPipeline.Orchestrator.BooleanPipeline.Start<Stage0To1Context>()
            .Then(Stage1Stage.Create());
